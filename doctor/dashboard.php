    ...
    <main class="dashboard-main">
        ...
        <section class="stats-grid">
            <article>
                ...
                <strong><?=$st['pending']??0?></strong>
                <small>Needs your decision</small>
            </article>
            <article>
                <span>Confirmed</span>
                <strong><?=$st['confirmed']??0?></strong>
                <small>Upcoming consultations</small>
            </article>
            <article>
                <span>Completed</span>
                <strong><?=$st['completed']??0?></strong>
                <small>Care delivered</small>
            </article>
            <article>
                <span>No Shows</span>
                <strong style="color: var(--danger);"><?=$st['noshow']??0?></strong>
                <small>Missed appointments</small>
            </article>
        </section>
